...
int main(){
    ...
    std::cout << size_in_bits((short)42) << std::endl;    // Integer
    std::cout << size_in_bits(123456789L) << std::endl;    // Integer
    std::cout << size_in_bits(std::string("Hello")) << std::endl;    // Integer
    std::cout << size_in_bits(true) << std::endl;    // Integer
